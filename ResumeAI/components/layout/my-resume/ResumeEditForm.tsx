  ...
  return (
    <div className="flex flex-col gap-5">
          ...
          <Button
            ...
            onClick={async () => {
              if (activeFormIndex !== 9) {
                ...
                const projectResult = await addProjectToResume(params.id, updates.projects);
                const certificateResult = await addCertificateToResume(params.id, updates.certificates);
                const awardResult = await addAwardToResume(params.id, updates.awards);
                const languageResult = await addLanguageToResume(params.id, updates.languages);
      ...
      {activeFormIndex === 1 ? (
        ...
        <AwardForm params={params} />
      ) : activeFormIndex === 9 ? (
        <LanguageForm params={params} />
      ) : activeFormIndex === 10 ? (
