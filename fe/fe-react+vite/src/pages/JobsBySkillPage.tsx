...
import { callFetchSkillById } from '@/services/skill.service';
...
//useSearchParams is a React Hook provided by the react-router-dom library that helps you read and edit parameters in the URL query string (the part after the ?)
