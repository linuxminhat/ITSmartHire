...
import LanguagePreview from "./previews/LanguagePreview";
import AwardPreview from "./previews/AwardPreview";
...
const ResumePreview = ({ download = false }) => {
  ...
  const sections = [
    ...
    },
    {
      ...
      condition: formData?.certificates?.length > 0,
    },
    {
      index: 7,
    ...
    {
      index: 8,
      component: <LanguagePreview />,
      condition: formData?.languages?.length > 0,
    },
    {
      index: 9,
      component: <AwardPreview />,
      condition: formData?.awards?.length > 0,
    },
  ];
